...
const CERTIFICATES = [
  ...
  },
  {
    ...
    date: '2023',
    img: '/certificates/Sertifikat FeArstyc_Tim Voli_Juara 2_Anak Jenderal.jpg',
    file: '/certificates/Sertifikat FeArstyc_Tim Voli_Juara 2_Anak Jenderal.jpg',
  },
  {
...
const PROJECTS = [
  {
    ...
    images: [
      ...
      '/project/Seminar Hasil Saya (1).png',
      '/project/Seminar Hasil Saya (2).png',
    ],
